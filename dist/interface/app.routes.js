...
const topSecretController = __importStar(require("./controllers/topSecret/topSecret.controller"));
const topSecretSplitController = __importStar(require("./controllers/topSecretSplit/topSecretSplit.controller"));
